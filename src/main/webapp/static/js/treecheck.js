...
layui.define("jquery", function (exports) {
    ...
    var o = layui.jquery,
        ...
        num = 1;
    treecheck.prototype.init = function (opition) {
        var self = this;
        this.options = opition;
        var e=o(opition.elem);
        e.addClass("layui-box layui-tree"),
            //如果o.options.skin存在则执行后面的方法
        self.options.skin && e.addClass("layui-tree-skin-" + self.options.skin),
            self.tree(e),
            self.on(e)
    },
    treecheck.prototype.tree = function (e, a) {//生成树
            var r = this,
                i = r.options,
                n = a || i.nodes;
        ...
        treecheck.prototype.changed = function (e, o) {
            //当checkbox的值改变后所处理动作
            var r = this;
    ...
    treecheck.prototype.cancelParentsCheckboxCheck = function (ele) {
    ...
    treecheck.prototype.siblingInputs = function (ele) {
    ...
    treecheck.prototype.currentChildrenInputs = function (ele) {
    ...
    treecheck.prototype.inputChecked = function (ele, checked) {
            //checkbox选中或不选中
            //input.setAttribute("checked","checked");/*使用这种方式在chrome中会有显示不出来勾选的问题*/
            ele && (ele.checked = checked);
        };
    treecheck.prototype.parentsChecked = function (e, checked) {
    ...
    treecheck.prototype.findParents = function (ele, selector) {
            //查找元素的指定父元素
            var parent = ele.parentElement,
                that = this;
    ...
    treecheck.prototype.uuid = function () {
            //生成唯一的字符串
            var that = this,
    ...
    treecheck.prototype.click = function (e, o) {
            var a = this,
                r = a.options;
    ...
    treecheck.prototype.spread = function (e, o) {
            //这个方法的功能是展开子节点
            var a = this,
            //r就是小箭头
    ...
    treecheck.prototype.on = function (e) {
            var a = this,
                i = a.options,
                t = "layui-tree-drag";
    ...
    treecheck.prototype.move = {};
    treecheck.prototype.drag = function (e, a) {
            var i = this,
        ...
        var treecheck=new treecheck();
        //暴露接口
        exports("treecheck", treecheck);
})
